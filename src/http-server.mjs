...
export function createDashboardServer({ config, adapter, local = adapter, remoteMessageService = null, remoteThreadSettingsService = null, turboCoordinator = null, turboPolicyService = null, skillSyncService = null, localSkillAdapter = null, projectCopyService = null, nodeRuntimeService = null, diagnosticsService = null, restartService = null, zoteroAdapter = null, zoteroLocalApi = null, dispatchStore = null, contextWindowStore = null, modelCatalog = null, logger = console }) {
  assertLoopbackConfig(config);
  const handlers = createDashboardHandlers({ config, adapter, local, remoteMessageService, remoteThreadSettingsService, turboCoordinator, turboPolicyService, skillSyncService, localSkillAdapter, projectCopyService, nodeRuntimeService, diagnosticsService, restartService, zoteroAdapter, zoteroLocalApi, dispatchStore, contextWindowStore, modelCatalog });
